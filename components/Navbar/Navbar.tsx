...
import { Menu, Center, Burger } from '@mantine/core';
...
const links = [
  {
    ...
    label: '文章',
    links: [
      { link: '/list/post', label: '文章列表' },
      { link: '/category/post', label: '文章分类' },
    ],
  },
  {
    link: '#comic',
    label: '漫画',
    links: [
      { link: '/list/comic', label: '漫画列表' },
      { link: '/category/comic', label: '漫画分类' },
    ],
  },
  {
    link: '#magazine',
    label: '杂志',
    links: [
      { link: '/list/magazine', label: '杂志列表' },
      { link: '/category/magazine', label: '杂志分类' },
    ],
  },
  {
    link: '#magazine',
    ...
    <>
      <div className="flex flex-col transition-all ease-in-out">
        ...
        >
            ...
            <div className="flex  items-center justify-between h-16">
              <div className="flex items-center">
                <Link className="flex-shrink-0" href="/">
                  <Image src="/images/logo/logo.svg" alt="Logo" width={165} height={32} />
                </Link>
                <div className="hidden md:block">
                  <div className="ml-10 flex items-baseline space-x-4">{items}</div>
                </div>
              </div>
          ...
          <div className={opened ? 'block absolute top-[64px]' : 'hidden'} id="mobile-menu">
