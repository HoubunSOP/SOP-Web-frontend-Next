      ...
      <MainColumn>
        <article>
          <header className="px-[36px] pt-8 pb-6 relative">
            ...
            <div className="mb-6 text-center bg-[#F5F5F5] max-w-[100%] h-40 md:h-60 rounded-md top-0 left-0 object-cover inline">
              <Image className="w-full object-cover" radius="md" src={data.message.post_cover} />
            </div>
          </header>
          <div id="post-content">
            <div
              id="single_content"
              dangerouslySetInnerHTML={{ __html: data.message.post_content }}
            >
              {}
            </div>
          </div>
